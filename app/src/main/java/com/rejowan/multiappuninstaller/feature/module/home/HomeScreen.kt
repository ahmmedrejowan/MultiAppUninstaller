...
import com.rejowan.multiappuninstaller.feature.module.setting.SettingsScreen
...
fun HomeScreen(
    ...
    val showFirstTutorial by mainViewModel.isFirstLaunch.collectAsState()
    ...
    if (isSettingsVisible) {
        ...
        Scaffold(
            ...
            bottomBar = {
                ...
                val allVisiblePackages = currentAllPackages()
                ...
                SelectionBottomBar(
                    ...
                    onToggleSelectAll = {
                        if (allSelected) {
                            selectedApps = selectedApps - allVisiblePackages
                        } else {
                            selectedApps = selectedApps + allVisiblePackages
                            isSelecting = true
                        }
            ...
            PullToRefreshBox(
                isRefreshing = isRefreshing, onRefresh = onRefresh, modifier = Modifier.padding(innerPadding)
            ) {
                Timber.tag("HomeScreen").e("PullToRefreshBox recomposed, isRefreshing = $isRefreshing")
                HomeContent(
                        ...
                        if (selectedApps.isNotEmpty()) {
                            ...
                            uninstallQueue = selectedApps.filter { packageName ->
                                try {
                                    ...
                                    Timber.tag("HomeScreen").e(e, "Package not found during uninstall filtering: $packageName")
                                    false
                                }
                            }
                    ...
                    showFirstTutorial = showFirstTutorial == true,
                    onDismissFirstTutorial = {
                        mainViewModel.setFirstLaunchDone()
                    })
            }
